...
use crate::discord::mai_commands::{TodayDetailRowView, build_mai_today_detail_embed};
...
#[tokio::test]
#[ignore = "Sends a real DM to preview embed UI; requires DISCORD_BOT_TOKEN and DISCORD_USER_ID"]
async fn preview_embed_mai_today_detail_dm() -> eyre::Result<()> {
    dotenv().ok();
    ...
    let rows = vec![
        ...
        TodayDetailRowView {
            ...
            chart_type: "DX".to_string(),
            achievement_percent: Some(100.0000),
            rating_points: Some(310),
            achievement_new_record: true,
            first_play: false,
        },
        TodayDetailRowView {
            title: "Sample Song C".to_string(),
            chart_type: "DX".to_string(),
            achievement_percent: Some(97.6543),
            rating_points: Some(250),
            achievement_new_record: true,
            first_play: true,
        },
    ];
