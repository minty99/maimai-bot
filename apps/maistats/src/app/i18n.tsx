...
const translations = defineTranslations({
  ko: {
    ...
    'history.currentBest': '현재 최고',
    'history.totalGain': '총 상승',
    'history.improvements': '갱신 횟수',
    'history.focusPoint': '선택 포인트',
    'history.latestPoint': '최신 포인트',
  ...
  en: {
    ...
    'history.axisAchievement': 'Achievement',
    'history.axisTime': 'Time',
    'history.currentBest': 'Current best',
    'history.totalGain': 'Total gain',
    'history.improvements': 'Improvements',
    'history.focusPoint': 'Selected point',
    'history.latestPoint': 'Latest point',
